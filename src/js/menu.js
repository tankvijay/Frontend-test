        ...
        return this.each(function() {
            ...
            function createMobileStructure(menuobj) {
                if (menuobj.prev('.menu-icon').length == 0) {
                    menuobj.wrapAll('<div class="mainmenu_container"></div>');
            ...
            $('body').on('click touchstart', function(e) {
                if (menuobj.prev(".menu-icon").is(":visible")) {
                    if ($(e.target).closest(".mainmenu_container").length == 0 && !$(e.target).hasClass('active')) {
                        closeMobileMenu(menuobj);
                    }
                }
            });
            ...
            function closeMobileMenu(menuobj) {
                ...
                if ( 'ontouchstart' in window ) {
                    ...
                    $('body').on('click touchstart', function(e) {
                        if ($(e.target).closest(".mainmenu_container").length == 0) {
